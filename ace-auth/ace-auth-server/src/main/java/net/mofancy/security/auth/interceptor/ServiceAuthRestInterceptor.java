package net.mofancy.security.auth.interceptor;

import net.mofancy.security.auth.common.util.jwt.IJWTInfo;
import net.mofancy.security.auth.configuration.ClientConfiguration;
import net.mofancy.security.auth.service.AuthClientService;
import net.mofancy.security.auth.util.client.ClientTokenUtil;
import net.mofancy.security.common.exception.auth.ClientForbiddenException;
...
public class ServiceAuthRestInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        for(String client: authClientService.getAllowedClient(Integer.parseInt(clientConfiguration.getClientId()))){
