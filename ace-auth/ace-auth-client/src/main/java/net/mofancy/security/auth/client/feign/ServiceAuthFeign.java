package net.mofancy.security.auth.client.feign;
...
public interface ServiceAuthFeign {
    ...
    @RequestMapping(value = "/client/appPubKey",method = RequestMethod.POST)
    public ObjectRestResponse<byte[]> getAppPublicKey(@RequestParam("clientId") String clientId, @RequestParam("secret") String secret);
