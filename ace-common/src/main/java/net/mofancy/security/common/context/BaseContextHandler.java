package net.mofancy.security.common.context;

import net.mofancy.security.common.constant.CommonConstants;
import net.mofancy.security.common.util.StringHelper;
...
public class BaseContextHandler {
    ...
    public static Integer getMemberId(){
        Object value = get(CommonConstants.CONTEXT_KEY_MEMBER_ID);
    ...
    public static void setMemberId(String memberId){
        set(CommonConstants.CONTEXT_KEY_MEMBER_ID,memberId);
    }
